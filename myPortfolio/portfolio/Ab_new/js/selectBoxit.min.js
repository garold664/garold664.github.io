...
(function(c){c(window.jQuery,window,document)})(function(c,p,x,y){c.widget("selectBox.selectBoxIt",{VERSION:"3.8.1",options:{showEffect:"none",showEffectOptions:{},showEffectSpeed:"medium",hideEffect:"none",hideEffectOptions:{},hideEffectSpeed:"medium",showFirstOption:!0,defaultText:"",defaultIcon:"",downArrowIcon:"",theme:"default",keydownOpen:!0,isMobile:function(){return/iPhone|iPod|iPad|Silk|Android|BlackBerry|Opera Mini|IEMobile/.test(navigator.userAgent||navigator.vendor||p.opera)},"native":!1,
...
return this},_createUnorderedList:function(){var a=this,b,d,e,g,f,u,h,l="",m=a.originalElemId||"",m=c("<ul/>",{id:m&&m+"SelectBoxItOptions","class":"selectboxit-options",tabindex:-1}),v,w,t,q,k,r;a.options.showFirstOption||(a.selectItems.first().attr("disabled","disabled"),a.selectItems=a.selectBox.find("option").slice(1));a.selectItems.each(function(m){k=c(this);e=d="";b=k.prop("disabled");g=k.attr("data-icon")||"";u=(f=k.attr("data-iconurl")||"")?"selectboxit-option-icon-url":"";h=f?"style=\"background-image:url('"+
f+"');\"":"";v=k.attr("data-selectedtext");q=(w=k.attr("data-text"))?w:k.text();r=k.parent();r.is("optgroup")&&(d="selectboxit-optgroup-option",0===k.index()&&(e='<span class="selectboxit-optgroup-header '+r.first().attr("class")+'"data-disabled="true">'+r.first().attr("label")+"</span>"));k.attr("value",this.value);l+=e+'<li data-id="'+m+'" data-val="'+this.value+'" data-disabled="'+b+'" class="'+d+" selectboxit-option "+(c(this).attr("class")||"")+'"><a class="selectboxit-option-anchor"><span class="selectboxit-option-icon-container"><i class="selectboxit-option-icon '+
g+" "+(u||a.theme.container)+'"'+h+"></i></span>"+(a.options.html?q:a.htmlEscape(q))+"</a></li>";t=k.attr("data-search");a.textArray[m]=b?"":t?t:q;this.selected&&(a._setText(a.dropdownText,v||q),a.currentFocus=m)});if(a.options.defaultText||a.selectBox.attr("data-text")){var p=a.options.defaultText||a.selectBox.attr("data-text");a._setText(a.dropdownText,p);a.options.defaultText=p}m.append(l);a.list=m;a.dropdownContainer.append(a.list);a.listItems=a.list.children("li");a.listAnchors=a.list.find("a");
...
a.close()},backspace:function(){a.triggerEvent("backspace")},esc:function(){a.close()}}},_eventHandlers:function(){var a=this,b=a.options.nativeMousedown,d=a.options.customShowHideEvent,e,g,f=a.focusClass,h=a.hoverClass,n=a.openClass;this.dropdown.on({"click.selectBoxIt":function(){a.dropdown.trigger("focus",!0);a.originalElem.disabled||(a.triggerEvent("click"),b||d||a.toggle())},"mousedown.selectBoxIt":function(){c(this).data("mdown",!0);a.triggerEvent("mousedown");b&&!d&&a.toggle()},"mouseup.selectBoxIt":function(){a.triggerEvent("mouseup")},
...
"enable.selectBoxIt":function(){a.dropdown.removeClass(a.theme.disabled)},"open.selectBoxIt":function(){var b=a.list.find("li[data-val='"+a.dropdownText.attr("data-val")+"']");b.length||(b=a.listItems.not("[data-disabled=true]").first());a.currentFocus=+b.attr("data-id");b=a.listItems.eq(a.currentFocus);a.dropdown.addClass(n).removeClass(h).addClass(f);a.listItems.removeClass(a.selectedClass).removeAttr("data-active").not(b).removeClass(f);b.addClass(a.selectedClass).addClass(f);a.options.hideCurrent&&
...
function(){var a=this;a._addAttributes(a.selectBox.prop("attributes"),a.dropdown);a.selectItems.each(function(b){a._addAttributes(c(this).prop("attributes"),a.listItems.eq(b))});return a};h._addAttributes=function(a,b){var d=this.options.copyAttributes;a.length&&c.each(a,function(a,g){var f=g.name.toLowerCase(),e=g.value;"null"===e||-1===c.inArray(f,d)&&-1===f.indexOf("data")||b.attr(f,e)});return this};h._dynamicPositioning=function(){if("number"===c.type(this.listSize))this.list.css("max-height",
...
(this.listItems.eq(this.currentFocus).blur(),this.currentFocus=this.currentIndex=a,this.listItems.eq(this.currentFocus).focusin(),this._scrollToView("search"),this.triggerEvent("search"));return this};h._searchAlgorithm=function(a,b){var c=!1,e,g,f,h,n=this.textArray,l=this.currentText;e=a;for(f=n.length;e<f;e+=1){h=n[e];for(g=0;g<f;g+=1)-1!==n[g].search(b)&&(c=!0,g=f);c||(l=this.currentText=this.currentText.charAt(this.currentText.length-1).replace(/[|()\[{.+*?$\\]/g,"\\$0"));b=new RegExp(l,"gi");
if(3>l.length){if(b=new RegExp(l.charAt(0),"gi"),-1!==h.charAt(0).search(b)){this._setCurrentSearchOption(e);if(h.substring(0,l.length).toLowerCase()!==l.toLowerCase()||this.options.similarSearch)this.currentIndex+=1;return!1}}else if(-1!==h.search(b))return this._setCurrentSearchOption(e),!1;if(h.toLowerCase()===this.currentText.toLowerCase())return this._setCurrentSearchOption(e),this.currentText="",!1}return!0};h.search=function(a,b,c){this.currentText=c?this.currentText+a.replace(/[|()\[{.+*?$\\]/g,
...
h._mobile=function(a){this.isMobile&&(this._applyNativeSelect(),this._mobileEvents());return this};h.selectOption=function(a,b){var d=c.type(a);"number"===d?this.selectBox.val(this.selectItems.eq(a).val()).change():"string"===d&&this.selectBox.val(a).change();this._callbackSupport(b);return this}});
